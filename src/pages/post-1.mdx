...
Look into the .mdx file to see how this is done!
...
![](/images/image.jpg)
 ...
 You can create un-numbered references too.<Sidenote numbered={false}>Just use the syntax `<Sidenote numbered={false}>` in the Markdown.
Foo</Sidenote>
